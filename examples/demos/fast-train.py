...
universe = rel.universe.Relativist(screen_size = (15, 3), width=800, height=450)
...
rail_start = -40
rail_end   = 80
universe += rel.objects.Prism(universe, None, (None, None), np.array([[rail_start, -.25], [rail_end, -.25]]), (0, 0, 0))
