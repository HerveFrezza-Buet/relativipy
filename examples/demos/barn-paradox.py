...
universe += rel.objects.Prism(None, universe.C, (None, None), barn_up,   barn_color)
universe += rel.objects.Prism(None, universe.C, (None, None), barn_down, barn_color)
...
universe += rel.objects.Prism(None, universe.C, time_interval, door + np.array([.5, 0.]), barn_color)
universe += rel.objects.Prism(None, universe.C, time_interval, door - np.array([.5, 0.]), barn_color)
...
stick_color = (0, .5, 0)
universe += rel.objects.Prism(speed, universe.C, (None, None), stick, stick_color)
