...
universe = rel.scene.Universe(screen_size = (4, 2), width=800, height=450)
...
atoms = rel.objects.Points(None, universe.C, (None, None), atoms, (1, 0, 0))

dilatation_coef = 1.6 # Ok... I have tweaked it empirically.
electrons = np.array([[x, -dy] for x in Xs*dilatation_coef])
electrons = rel.objects.Points(current_speed, universe.C, (None, None), electrons, (0, .75, 0))
