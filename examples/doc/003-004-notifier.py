...
speed = None
universe += rel.objects.Events(speed, universe.C, events, (0, 0, 0))

# Now, let us define two notifiers. They aim at calling a function
# when an event occurs.

universe += rel.objects.Notifier(speed, universe.C, events[0], lambda t: print('A at {} s'.format(t)))
universe += rel.objects.Notifier(speed, universe.C, events[1], lambda t: print('B at {} s'.format(t)))
